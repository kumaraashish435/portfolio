      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="text-center md:text-left">
            ...
            <p className="text-sm text-gray-300">Software Engineer | Full Stack Developer</p>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-neutral-800 text-center text-xs text-gray-400 flex flex-col md:flex-row justify-between items-center">
